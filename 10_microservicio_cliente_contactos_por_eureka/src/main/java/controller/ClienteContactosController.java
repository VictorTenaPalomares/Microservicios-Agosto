...
public class ClienteContactosController {
	String urlBase="http://servicio-contactos"; // En este caso como estamos accediendo al servicio a través de eureka en vez de la dirección url del servicio tenemos que poner el nombre del servicio que nos lo suministra
	@Autowired
