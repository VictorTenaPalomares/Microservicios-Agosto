...
public class ContactosController {
	...
	// Inyectamos una implentación de la interfaz AgendaService
	@Autowired
	...
	@PutMapping(value = "contactos/{id}",consumes = MediaType.APPLICATION_JSON_VALUE)
	public void actualizarContacto(@RequestBody Contacto contacto) {
		service.actualizarContacto(contacto);		
	}
	
	@DeleteMapping(value="contactos/{id}",consumes =MediaType.APPLICATION_JSON_VALUE )
